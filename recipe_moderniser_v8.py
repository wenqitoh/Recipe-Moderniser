...
def round_amount(amount_to_round):
    if amount_to_round % 1 == 0:    # finds whole numbers
        ...
        amount_to_round = "{:.2f}".format(amount_to_round)  # everything else rounded to 2dp
...
def instructions():
    ...
    print("The program also asks for the number of servings. IF you are not sure, \n"
          "type '1'. Then when it asks you for servings required, you can increase\n"
